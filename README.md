...
- stakeCurrency: the staking token of the chain. Remove this item if your chain does not support native staking (e.g. if your chain uses replicated security) or does not have staking token.
